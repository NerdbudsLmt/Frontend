    ...
    <div className="flex justify-around gap-y-12 gap-x-3 flex-wrap my-16">
      <div className="relative blue_gradient w-[85%] tablet_l:max-w-[350px] rounded-3xl">
        <div className="pt-3 pb-2">
          <div className="border-white text-white text-[14px] mx-auto flex gap-2 items-center border-2 w-fit py-1 px-5 rounded-full">
        ...
        <Link
          href="/signup"
          className="border-[#265D80] bg-[#265D80] text-white text-[14px] mx-auto flex gap-2 items-center border-2 mt-8 mb-0 w-fit py-2 px-3 rounded-full transition-transform hover:scale-110"
        >
          Get Started
        ...
        <Link
          href="/contact"
          className="border-b-2 text-white text-[14px] mx-auto flex mt-2 mb-4 w-fit transition-transform hover:scale-110"
      ...
      <div className="relative black_graident w-[85%] tablet_l:max-w-[350px] rounded-3xl">
        ...
        <Link
          href="/signup"
          className="border-[#ffffff] bg-[#ffffff] text-[#151515] text-[14px] mx-auto flex gap-2 items-center border-2 mt-8 mb-0 w-fit py-2 px-3 rounded-full transition-transform hover:scale-110"
        >
          Get Started with Project Pal
          <BsArrowRight className="text-lg" />
        </Link>
      </div>
      <div className="relative yellow_gradient w-[85%] tablet_l:max-w-[350px] rounded-3xl pb-9">
        ...
        <Link
          href="/signup"
          className="border-[#B09334] bg-[#B09334] text-[#fff] text-[14px] mx-auto flex gap-2 items-center border-2 mt-8 mb-0 w-fit py-2 px-3 rounded-full transition-transform hover:scale-110"
        >
          Get Started
          <BsArrowRight className="text-lg" />
        </Link>
