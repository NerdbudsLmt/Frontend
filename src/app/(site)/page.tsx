  ...
  return (
    <>
      ...
      <div className=" text-center my-20">
        ...
        <p className="text-white text-[1rem] sm:text-[1.6rem] text-center font-medium ">
          Explore the prestige of GeekOps, a leading software company shaped by
          the expertise and dedication of founding partners. Our meticulously
          skilled team transforms your ideas into reality with unparalleled
          precision and innovation, nurturing the startup of your dreams.
        </p>
        <Link href="/about">
